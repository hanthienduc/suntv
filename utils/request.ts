...
export const tvShowRequests = {
  ...
  fetchTVOnTheAir: `${BASE_URL}/tv/top_rated?api_key=${API_KEY}&language=en-US`,
  fetchPopular: `${BASE_URL}/tv/on_the_air?api_key=${API_KEY}&language=en-US`,
  fetchTopRated: `${BASE_URL}/tv/popular?api_key=${API_KEY}&language=en-US`,
}
...
export function getRequests(category: string) {
  switch (category) {
    case 'tv-show':
      return tvShowRequests
